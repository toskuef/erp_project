...
var soft = {
  ...
  showSwal: function(type, cust_pk, task_pk, object) {
    if (type == 'basic') {
      Swal.fire('basic')
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          ...
          var path = ['/tasks/done/' + cust_pk + '/' + task_pk + '/' + object].join('')
          console.log(path)
          xhr.open(
              'GET',
              path,
          ...
          xhr.onreadystatechange = function () {
            ...
            if (xhr.status === 200) {
              document.getElementById('parentDiv').innerHTML = xhr.responseText
            } else {
