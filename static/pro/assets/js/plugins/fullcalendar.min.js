...
var FullCalendar = function (e) {
    ...
    L.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : L.FullCalendarVDom = {
        Component: E, createElement: g, render: U, createRef: function () {
            ...
            return t.Provider = function () {
                var e = this, t = !this.getChildContext,
    ...
    function Re(e, t, n, r) {
        var o = _e([t, 0, 1 + Te(t, n, r)]), i = we(e),
            a = Math.round(Se(o, i));
    ...
    function Ge(e, t, n) {
        var r = n.dateEnv, o = n.pluginHooks, i = n.options, a = e.defs,
            s = e.instances;
    ...
    function nt(e) {
        ...
        return e.days ? e.specifiedWeeks && e.days % 7 == 0 ? {
            unit: "week",
            value: e.days / 7
        } : {unit: "day", value: e.days} : e.months ? {
            unit: "month",
            value: e.months
    ...
    function it(e, t) {
        void 0 === t && (t = !1);
        var n = e < 0 ? "-" : "+", r = Math.abs(e), o = Math.floor(r / 60),
            i = Math.round(r % 60);
    ...
    var ut = {
            ...
            minute: 1,
            second: 1
        }, dt = /\s*([ap])\.?m\.?/i, pt = /,/g, ft = /\s+/g, ht = /\u200e/g,
        vt = /UTC|GMT/, gt = function () {
            function e(e) {
                var t = {}, n = {}, r = 0;
            ...
            return e.prototype.format = function (e, t) {
                ...
                var o = this.standardDateProps, i = this.extendedSettings,
                    a = function (e, t, n) {
    ...
    function Zt(e, t, n, r, o) {
        ...
        var c, d = function (e, t, n, r) {
            var o, i, a = e.allDay, s = null, l = !1, u = null,
    ...
    function cn(e, t, n, r) {
        ...
        for (var d in e.instances) {
            var p = e.instances[d], f = u[(S = e.defs[p.defId]).defId],
                h = p.range, v = !S.allDay && r ? Qt(h, r) : h, g = on(v, n);
    ...
    function Dn(e, t, n, r, o, i, a) {
        var s = n.dateEnv, l = n.options, u = l.displayEventTime,
            c = l.displayEventEnd, d = e.eventRange.def,
            p = e.eventRange.instance;
        null == u && (u = !1 !== r), null == c && (c = !1 !== o);
        var f = p.range.start, h = p.range.end,
    ...
    function Tn(e, t, n) {
        var o = function (e, t) {
            var n = It(e, Rn), o = n.refined, i = n.extra,
    ...
    var zn = function () {
        ...
        return e.prototype.getCurrentData = function () {
            ...
            var t, n, r = this.getCurrentData(), o = r.viewSpecs,
                i = r.toolbarConfig, a = [].concat(i.viewsWithButtons);
            ...
            var t = this.getCurrentData(), n = t.eventStore, r = n.defs,
                o = n.instances;
        ...
        return e.prototype.setProp = function (e, t) {
            var n, r;
            if (e in qt) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead."); else if ("id" === e) t = Gt[e](t), this.mutate({standardProps: {publicId: t}}); else if (e in Gt) t = Gt[e](t), this.mutate({standardProps: (n = {}, n[e] = t, n)}); else if (e in Vt) {
                var o = Vt[e](t);
                "color" === e ? o = {
                    backgroundColor: t,
                    borderColor: t
            ...
            void 0 === n && (n = {});
            var r, o, i, a = this._context.dateEnv, s = {allDay: n.allDay},
                l = a.createMarker(e);
            ...
            if (n) {
                var r = this._def, o = this._context,
                    i = o.getCurrentData().eventStore, a = Ot(i, n.instanceId);
                a = Hn(a, {
                    "": {
                        display: "",
                        startEditable: !0,
            ...
            void 0 === e && (e = {});
            var t = this._def, n = t.ui, o = this.startStr, i = this.endStr,
                a = {};
    ...
    var fr = {defs: {}, instances: {}}, hr = function () {
        ...
        return e.prototype.splitProps = function (e) {
            var t = this, n = this.getKeyInfo(e),
    ...
    function wr(e, t) {
        ...
        var n = window.getComputedStyle(e),
            ...
            a = parseInt(n.borderBottomWidth, 10) || 0, s = Cr(e),
            l = s.y - r - o, u = {
                borderLeft: r,
                borderRight: o,
                borderTop: i,
    ...
    var Or = FullCalendarVDom.Component, Ar = FullCalendarVDom.createElement,
        Ur = FullCalendarVDom.render, Lr = FullCalendarVDom.createRef,
        Wr = FullCalendarVDom.Fragment, Vr = FullCalendarVDom.createContext,
        Fr = FullCalendarVDom.flushToDom,
        zr = FullCalendarVDom.unmountComponentAtNode, Br = function () {
            function e(e, t, n) {
                var o = this;
    ...
    function no(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, o) {
            var i = t.getCurrentData(), a = e.eventDrag, s = a.mutatedEvents,
                l = s.defs, u = s.instances,
            ...
            for (var m in u) {
                ...
                for (var T = i.eventStore, k = 0, M = S.allows; k < M.length; k++) {
                    var x = M[k],
                        ...
                        I = T.defs[D.defId], P = T.instances[m], N = void 0;
                    if (N = I ? new Bn(t, I, P) : new Bn(t, D), !x(Pn(_, t), N)) return !1
                }
            }
            return !0
        }(e, t, n, o)) && !(e.dateSelection && !function (e, t, n, o) {
            var i = e.eventStore, a = i.defs, s = i.instances,
                l = e.dateSelection, u = l.range,
    ...
    var go = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.context.pluginHooks.contentTypeHandlers,
                t = this.props, n = this.customContentInfo,
    ...
    var Do = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options,
                r = {view: t.viewApi},
    ...
    var To = function () {
        ...
        return e.prototype.buildPrev = function (e, t, n) {
            ...
            var t = this.props, n = t.dateEnv, r = t.usesMinMaxTime,
                o = t.slotMinTime, i = t.slotMaxTime, a = e.start, s = e.end;
            ...
            var r, o = this.props, i = o.dateEnv, a = o.dateAlignment, s = 0,
                l = e;
    ...
    function No(e, t, n, o) {
        var i = o.options, a = o.calendarApi,
            s = o.pluginHooks.eventSourceDefs[e.sourceDefId], l = ee();
        return s.fetch({
            eventSource: e,
            range: t,
            isRefetch: n,
    ...
    function Fo(e, t, n, r, o, i, a) {
        return Ue(e, (function (e) {
            return function (e, t, n, r, o, i, a) {
                var s = "rtl" === t.direction, l = t.customButtons || {},
                    u = n.buttonText || {}, c = t.buttonText || {};
        ...
        recurringTypes: [{
            parse: function (e, t) {
                ...
                return r ? function (e, t, n, r) {
                    var o = e ? Le(e) : null, i = we(n.start), a = n.end,
                        s = [];
                    for (; i < a;) {
                        var l = void 0;
    ...
    var Jo = function () {
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            var t = this.props, n = this.state, o = this.emitter,
                i = function (e, t) {
                    var n;
                    switch (t.type) {
                        case"SET_OPTION":
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props, d = this.state,
                p = this.data,
                ...
                v = this.data = r(r(r({
                    ...
                    emitter: this.emitter,
                    getCurrentData: this.getCurrentData
                }, f), h), d), g = f.pluginHooks.optionChangeHandlers,
                m = p && p.calendarOptions, y = f.calendarOptions;
            ...
            var r = this.processRawCalendarOptions(e, t), o = r.refinedOptions,
                i = r.pluginHooks, a = r.localeDefaults,
            ...
            var n = _t([wt, e, t]), o = n.locales, i = n.locale,
                a = this.organizeRawLocales(o), s = a.map,
    ...
    var yi = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            for (var t = this.props, n = this.context.theme, i = [], a = !0, s = 0, l = e; s < l.length; s++) {
                var u = l[s], c = u.buttonName, d = u.buttonClick,
                    p = u.buttonText, f = u.buttonIcon;
        ...
        return n(t, e), t.prototype.render = function () {
            var e, t, n = this.props, r = n.model, o = n.extraClassName,
                i = !1, a = r.center;
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var n = this.props, r = n.dateEnv, o = n.options,
                i = n.calendarApi, a = t.getAttribute("data-navlink");
            a = a ? JSON.parse(a) : {};
    ...
    function wi(e, t, n, r, o, i) {
        var a = n.build(o, void 0, !1), s = n.buildPrev(t, r, !1),
            l = n.buildNext(t, r, !1);
        return {
            title: i,
            activeButton: e.type,
    ...
    var _i = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.dateEnv, n = e.options, o = e.theme,
                i = e.viewApi, a = this.props, s = a.date, l = a.dateProfile,
                u = gr(s, a.todayRange, null, l), c = [Mi].concat(mr(u, o)),
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.dateEnv, o = t.theme,
                i = t.viewApi, a = t.options, s = me(new Date(2592e5), e.dow),
                l = {
                    dow: e.dow,
                    isDisabled: !1,
                    isFuture: !1,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return i = Math.min(864e5, i), {
                currentState: {
                    nowDate: r,
                    todayRange: Ni(r)
                }, nextState: {nowDate: o, todayRange: Ni(o)}, waitMs: i
            }
        }, t.prototype.setTimeout = function () {
            var e = this, t = this.computeTiming(), n = t.nextState,
                r = t.waitMs;
    ...
    var Hi = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = this.props, n = t.dates,
                r = t.dateProfile, o = t.datesRepDistinctDays,
                i = t.renderIntro,
    ...
    var Ai = function () {
        ...
        return e.prototype.sliceRange = function (e) {
            var t = this.getDateDayIndex(e.start),
                n = this.getDateDayIndex(me(e.end, -1)), r = Math.max(0, t),
    ...
    var Vi = /^(visible|hidden)$/, Fi = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = e.liquid, n = e.liquidIsAbsolute,
                r = t && n, o = ["fc-scroller"];
    ...
    var na = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.state, n = this.context,
                r = e.sections || [], i = this.processCols(e.cols),
                a = this.renderMicroColGroup(i, t.shrinkWidth),
                s = Ji(e.liquid, n);
            e.collapsibleWidth && s.push("fc-scrollgrid-collapsible");
            for (var l, u = r.length, c = 0, d = [], p = [], f = []; c < u && "header" === (l = r[c]).type;) d.push(this.renderSection(l, a)), c += 1;
            ...
            var r = this.props, o = this.state, i = o.forceYScrollbars,
                a = o.scrollerClientWidths, s = o.scrollerClientHeights,
                l = Gi(r, e), u = ji(r, e),
            ...
            var e = br(), t = this.scrollerRefs, n = this.scrollerElRefs,
                r = !1, o = {}, i = {};
    ...
    var ra = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = e.seg,
                o = r.eventRange, i = o.ui, a = {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = e.seg,
    ...
    var ha = function (e) {
        return Ar(jr.Consumer, null, (function (t) {
            var n = t.dateEnv, r = t.options, o = e.date,
    ...
    var ba = function () {
        ...
        }(Ca), Ta = "function" == typeof performance ? performance.now : Date.now,
        ka = function () {
            function e() {
                var e = this;
            ...
            return e.prototype.start = function (e, t) {
                ...
                var n = e.scrollCache, r = this.edgeThreshold,
                    o = r - e.distance,
                ...
                for (var n = this.edgeThreshold, r = null, o = 0, i = this.scrollCaches; o < i.length; o++) {
                    var a = i[o], s = a.clientRect, l = e - s.left,
                        u = s.right - e, c = t - s.top, d = s.bottom - t;
        ...
        return e.prototype.processFirstCoord = function (e) {
            ...
            for (var i in n) {
                ...
                if (s && s.isWithinClipping(e, t)) {
                    var l = s.computeLeft(), u = s.computeTop(), c = e - l,
                        d = t - u, p = s.origRect, f = p.right - p.left,
                        h = p.bottom - p.top;
                    if (c >= 0 && c < f && d >= 0 && d < h) {
    ...
    var Oa = function (e) {
        function t(n) {
            ...
            o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                var t = e.origEvent.target, n = o, r = n.component,
                    i = n.dragging, a = i.mirror, s = r.context.options,
                    l = r.context;
                ...
                var t = o.component.context, n = o.eventRange,
                ...
                if (o.isDragging) {
                    var n = o.relevantEvents, r = o.hitDragging.initialHit,
                        i = o.component.context, a = null, s = null, l = null,
                        u = !1, c = {
                            affectedEvents: n,
                    ...
                    if (e) {
                        ...
                        i === a || p.editable && p.droppable ? (s = function (e, t, n) {
                            var r = e.dateSpan, o = t.dateSpan,
                                i = r.range.start, a = o.range.start, s = {};
                ...
                if (o.isDragging) {
                    var t = o.component.context, n = t.viewApi, i = o,
                        a = i.receivingContext, s = i.validMutation,
                        l = o.eventRange.def, u = o.eventRange.instance,
                        c = new Bn(t, l, u), d = o.relevantEvents,
    ...
    var Aa = function (e) {
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                var t = n.component, r = fn(n.querySegEl(e)),
                ...
                var i = n.component.context, a = n.relevantEvents,
                    s = n.hitDragging.initialHit, l = n.eventRange.instance,
                    u = null, c = null, d = !1, p = {
                        affectedEvents: a,
                        mutatedEvents: {defs: {}, instances: {}},
                        isEvent: !0
                ...
                var t = n.component.context, o = n.eventRange.def,
                    i = n.eventRange.instance, a = new Bn(t, o, i),
    ...
    var Ua = function () {
        function e(e) {
            ...
            this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = function (e) {
                ...
                var n = t.context, r = t.documentPointer,
                    o = n.getCurrentData();
                if (!r.wasTouchScroll) {
        ...
        function e(e, t) {
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                var i = n.hitDragging.dragging, a = null, s = null, l = !1,
                    u = {
                ...
                if (n.clearDrag(), o && i) {
                    var a = n.hitDragging.finalHit,
                        s = a.component.context.viewApi, l = n.dragMeta;
    ...
    var Fa = function () {
        function e(e, t) {
            ...
            void 0 === t && (t = {}), this.handlePointerDown = function (e) {
                var t = n.dragging, r = n.settings, o = r.minDistance,
                    i = r.longPressDelay;
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t) {
            ...
            var i = this.props, a = this.context,
                s = !i.forPrint && ea(a.options),
                l = !i.forPrint && ta(a.options), u = [];
            return e && u.push({
                type: "header",
                key: "header",
                isSticky: s,
    ...
    var Xa = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context.options.navLinks ? {
    ...
    var Ja = bt({week: "narrow"}), $a = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, o = t.viewApi,
                i = this.props, a = i.date, s = i.dateProfile, l = {
                    num: i.moreCnt,
            ...
            segsByEachCol: u.map((function (t, n) {
                ...
                return o = function (e, t, n) {
                    for (var o = t, i = me(o, 1), a = {
                        ...
                        var c = u[l], d = c.eventRange, p = d.range,
                            f = on(p, a);
                        f && s.push(r(r({}, c), {
                            firstCol: n,
                            lastCol: n,
    ...
    var ls = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.props, n = this.state, o = this.context,
                i = t.cells.length, a = Ya(t.businessHourSegs, i),
                s = Ya(t.bgEventSegs, i), l = Ya(this.getHighlightSegs(), i),
                ...
                d = c.paddingBottoms, p = c.segsByFirstCol,
                f = c.segsByEachCol, h = c.segIsHidden, v = c.segTops,
            ...
            var c = this.context, d = this.props.eventSelection,
                p = this.state.framePositions,
                f = 1 === this.props.cells.length, h = [];
            if (p) for (var v = 0, g = e; v < g.length; v++) {
                var m = g[v], y = m.eventRange.instance.instanceId,
                    E = s || l || u, S = i[y], D = t[y] || S,
                    b = t[y] || E || m.firstCol !== m.lastCol || !m.isStart || !m.isEnd,
                    C = void 0, w = void 0, R = void 0, T = void 0;
            ...
            var n = this.context.isRtl, i = this.props.todayRange,
                a = this.state.framePositions, s = [];
            ...
            var e = this.props.cells[0].key, t = this.cellElRefs.currentMap[e],
    ...
    var us = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.props, t = e.alignmentEl, n = e.topAlignmentEl,
                r = this.rootEl;
            if (r) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.options, n = e.dateEnv, o = this.props,
                i = o.date, a = o.hiddenInstances, s = o.todayRange,
                l = o.dateProfile, u = o.selectedInstanceId,
            ...
            if (!n || !r) return null;
            var o = n.getBoundingClientRect(), i = r.getBoundingClientRect(),
                a = i.left - o.left, s = i.top - o.top, l = e - a, u = t - s,
                c = this.props.date;
        ...
        function t() {
            ...
            return t.splitBusinessHourSegs = st(qa), t.splitBgEventSegs = st(qa), t.splitFgEventSegs = st(qa), t.splitDateSelectionSegs = st(qa), t.splitEventDrag = st(Za), t.splitEventResize = st(Za), t.buildBuildMoreLinkText = st(ps), t.morePopoverRef = Lr(), t.rowRefs = new zi, t.state = {morePopoverState: null}, t.handleRootEl = function (e) {
                ...
                function a(e) {
                    var t = e.eventRange, r = t.def, i = t.instance,
                        a = t.range;
                    return {
                        event: new Bn(n, r, i),
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.props, n = t.dateProfile,
                o = t.dayMaxEventRows, i = t.dayMaxEvents, a = t.expandRows,
                s = this.state.morePopoverState, l = t.cells.length,
            ...
            var a = this.colPositions, s = this.rowPositions,
                l = a.leftToIndex(e), u = s.topToIndex(t);
    ...
    var hs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options,
                r = t.dateProfileGenerator, o = this.props,
    ...
    var Cs = function (e) {
        ...
        function t() {
            ...
            return t.allDaySplitter = new Es, t.headerElRef = Lr(), t.rootElRef = Lr(), t.scrollerElRef = Lr(), t.state = {slatCoords: null}, t.handleScrollTopRequest = function (e) {
                ...
                var o = t.context.options, i = t.props.dateProfile.renderRange,
                    a = Se(i.start, i.end), s = o.navLinks && 1 === a ? {
                ...
                var n = t.context, r = n.options, o = n.viewApi,
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t, n) {
            ...
            var u = this.context, c = this.props,
                d = !c.forPrint && ea(u.options),
                p = !c.forPrint && ta(u.options), f = [];
            e && f.push({
                type: "header",
                key: "header",
                isSticky: d,
            ...
            var e = this.context.options, t = e.dayMaxEvents,
                n = e.dayMaxEventRows;
    ...
    var ks = function () {
        ...
        return e.prototype.safeComputeTop = function (e) {
            ...
            var t, n, r = this.positions, o = this.dateProfile,
                i = r.els.length,
    ...
    function As(e, t, n, r) {
        ...
        if (null == e.forwardCoord) for (i.length ? (!function (e, t) {
            var n = e.map(Us), r = [{
                ...
                order: -1
            }, {field: "backwardCoord", order: 1}].concat(t);
            n.sort((function (e, t) {
                return le(e, t, r)
            })), n.map((function (e) {
                return e._seg
    ...
    var Fs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var t, n, o = this.context, i = o.isRtl,
                a = o.options.slotEventOverlap, s = e.backwardCoord,
                l = e.forwardCoord;
    ...
    var Bs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var n = this.context, r = n.dateEnv, o = n.options,
                i = this.colCoords, a = this.props.dateProfile,
                s = this.state.slatCoords,
                l = this.processSlotOptions(this.props.slotDuration, o.snapDuration),
                u = l.snapDuration, c = l.snapsPerSlot, d = i.leftToIndex(e),
                p = s.positions.topToIndex(t);
            if (null != d && null != p) {
                var f = s.positions.tops[p], h = s.positions.getHeight(p),
                    v = (t - f) / h, g = p * c + Math.floor(v * c),
                    m = this.props.cells[d].date,
                    y = Je(a.slotMinTime, $e(u, g)), E = r.add(m, y);
                return {
                    col: d,
                    dateSpan: {
    ...
    var Gs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.props, n = this.context, o = t.dateProfile,
                i = t.dayTableModel, a = n.options.nowIndicator,
    ...
    var Ks = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, o = t.dateEnv,
                i = t.dateProfileGenerator, a = this.props, s = a.dateProfile,
    ...
    var $s = lo({
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = e.dayDate, n = e.todayRange,
                o = this.context, i = o.theme, a = o.dateEnv, s = o.options,
                l = o.viewApi, u = gr(t, n),
                c = s.listDayFormat ? a.format(t, s.listDayFormat) : "",
                d = s.listDaySideFormat ? a.format(t, s.listDaySideFormat) : "",
                p = s.navLinks ? yr(t) : null, f = r({
                    date: a.toDate(t),
                    view: l,
                    text: c,
                    sideText: d,
                    navLinkData: p
                }, u), h = ["fc-list-day"].concat(mr(u, i));
            return Ar(fo, {
                hookProps: f,
                    ...
                    return Ar("tr", {
                        ...
                        if (!1 !== r.displayEventTime) {
                            var o = e.eventRange.def,
                                i = e.eventRange.instance, a = !1, s = void 0;
    ...
    var il = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.props, n = this.context,
                ...
                o = this.computeDateVars(t.dateProfile), i = o.dayDates,
                a = o.dayRanges,
            ...
            var e = this.context, t = e.options, n = e.viewApi,
            ...
            var n = this.context, o = n.theme, i = n.options,
                a = function (e) {
                    var t, n, r = [];
            ...
            var n, r, o, i = this.context.dateEnv,
                a = this.context.options.nextDayThreshold, s = e.range,
                l = e.def.allDay, u = [];
    ...
    var pl = lo({
        eventSourceDefs: [{
            parseMeta: function (e) {
                ...
                var o = e.context, i = o.dateEnv, a = o.options,
    ...
    return Go.push(ja, ys, $s, ul, dl, pl), e.BASE_OPTION_DEFAULTS = wt, e.BASE_OPTION_REFINERS = Ct, e.BaseComponent = Yr, e.BgEvent = pa, e.BootstrapTheme = cl, e.Calendar = ga, e.CalendarApi = zn, e.CalendarContent = Ci, e.CalendarDataManager = Jo, e.CalendarDataProvider = li, e.CalendarRoot = Ti, e.Component = Or, e.ContentHook = vo, e.CustomContentRenderContext = ho, e.DateComponent = so, e.DateEnv = Jn, e.DateProfileGenerator = To, e.DayCellContent = la, e.DayCellRoot = ca, e.DayGridView = gs, e.DayHeader = Hi, e.DaySeriesModel = Ai, e.DayTable = vs, e.DayTableModel = Ui, e.DayTableSlicer = hs, e.DayTimeCols = qs, e.DayTimeColsSlicer = Gs, e.DayTimeColsView = Ks, e.DelayedRunner = Zo, e.Draggable = Fa, e.ElementDragging = hi, e.ElementScrollController = Pr, e.Emitter = xr, e.EventApi = Bn, e.EventRoot = ra, e.EventSourceApi = V, e.FeaturefulElementDragging = Ma, e.Fragment = Wr, e.Interaction = ci, e.ListView = il, e.MountHook = mo, e.NamedTimeZoneImpl = ui, e.NowIndicatorRoot = aa, e.NowTimer = Pi, e.PointerDragging = Sa, e.PositionCache = _r, e.RefMap = zi, e.RenderHook = fo, e.ScrollController = Ir, e.ScrollResponder = Br, e.Scroller = Fi, e.SimpleScrollGrid = na, e.Slicer = Li, e.Splitter = hr, e.StandardEvent = oa, e.Table = ds, e.TableDateCell = _i, e.TableDowCell = Ii, e.TableView = Ga, e.Theme = Hr, e.ThirdPartyDraggable = Ba, e.TimeCols = Bs, e.TimeColsSlatsCoords = ks, e.TimeColsView = Rs, e.ViewApi = Un, e.ViewContextType = jr, e.ViewRoot = Do, e.WeekNumberRoot = ha, e.WindowScrollController = Nr, e.addDays = me, e.addDurations = Je, e.addMs = ye, e.addWeeks = ge, e.allowContextMenu = ae, e.allowSelection = oe, e.applyMutationToEventStore = Hn, e.applyStyle = q, e.applyStyleProp = Y, e.asCleanDays = function (e) {
        ...
        var r = rr("object" == typeof n && n ? n : {}), o = bt(n),
            i = r.createMarkerMeta(e), a = r.createMarkerMeta(t);
    ...
    },e.triggerDateSelect = In,e.unmountComponentAtNode = zr,e.unpromisify = Mr,e.version = "5.6.0",e.whenTransitionDone = $,e.wholeDivideDurations = tt,Object.defineProperty(e, "__esModule", {value: !0}),e
}({});