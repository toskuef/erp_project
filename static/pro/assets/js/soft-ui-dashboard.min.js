...
var calendarEl, today, mYear, weekday, mDay, m, d, calendar, allInputs,
    fixedPlugin, fixedPluginButton, fixedPluginButtonNav, fixedPluginCard,
    fixedPluginCloseButton, navbar, buttonNavbarFixed,
...
function darkMode(e) {
    const t = document.getElementsByTagName("body")[0],
        ...
        w = document.querySelector(".navbar-brand-img"), L = w.src,
...
var soft = {
    initFullCalendar: function () {
        document.addEventListener("DOMContentLoaded", function () {
            var e = document.getElementById("fullCalendar"), t = new Date,
                a = t.getFullYear(), n = t.getMonth(), t = t.getDate(),
        ...
        if ("basic" == e) Swal.fire("Any fool can use a comffffffputer"); else if ("title-and-text" == e) {
            const t = Swal.mixin({
                customClass: {
